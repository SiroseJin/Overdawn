...
const ENEMY_SCENES := {
	"Bat":   preload("res://scene/bat_enemy.tscn"),
	"Frog":  preload("res://scene/frog_enemy.tscn"),
	"Witch": preload("res://scene/witch_enemy.tscn"),
	"Necro": preload("res://scene/necromancer_enemy.tscn"),
	"Boss":  preload("res://scene/finalboss_enemy.tscn"),
}
